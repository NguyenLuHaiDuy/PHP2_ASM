<?php
 ...
 ?>
<div class="col-md-12">
    <h2 style="text-align: center">Thiết bị</h2>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-hover">
                <tr>
                    <th style="width: 100px;">Ảnh thiết bị</th>
                    <th>Tên</th>
                    <th style="width:150px;">Danh mục thiết bị</th>
                    <th style="width:150px;">Số lượng thiết bị</th>
                    <th style="width: 70px;">Giá thiết bị</th>
                    <th style="width: 70px;">Giảm giá</th>
                    <th style="width:70px;">Thiết bị hot</th>
