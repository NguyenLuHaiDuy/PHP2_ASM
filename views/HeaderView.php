...
<div class="container">
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 mini-cart">
      <div class="wrapper-mini-cart"> <span class="icon"><i class="fa fa-shopping-cart"></i></span> <a href="index.php?controller=cart"> <span class="mini-cart-count"> <?php echo $numberProduct; ?> </span> thiết bị <i class="fa fa-caret-down"></i></a>
  ...
  <div class="container">
    <div class="clearfix">
      <ul class="main-nav hidden-xs hidden-sm list-unstyled">
        ...
        <li class="has-submenu"> <a href="#"> <span>Thiết bị</span><i class="fa fa-caret-down" style="margin-left: 5px;"></i> </a>
